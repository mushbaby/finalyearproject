...
public class HairdresserRegistrationActivity extends AppCompatActivity {
    ...
    regPageQuestion.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
                Intent intent = new Intent(HairdresserRegistrationActivity.this, LoginActivity.class);
